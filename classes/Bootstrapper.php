...
{
	protected static $arrSkipTypes = array('hidden', 'fieldset', 'subEventList', 'successGroup', 'formcolstart', 'formcolpart', 'formcolend', 'multiColumnWizard', 'form_multiColumnWizard', 'multifileupload');
